...
public interface Config {
	...
	public static final int REQUEST_DEL_FRIEND = 1019; //	删除好友请求
	...
	public static final int REQUEST_GET_SUBJECT = 1017;//PK结果
	public static final int REQUEST_MODIFY_MONEY = 1018;//充值
	public static final int REQUEST_MODIFY_TIME = 1020;//修改时间
	public static final int REQUEST_MODIFY_INFO = 1021;//修改用户名密码
